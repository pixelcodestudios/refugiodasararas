(function () {
  ...
  const CONFIG = {
    ...
    AIRBNB_URL: "https://www.airbnb.com/h/chacararefugiodasararas",
    BOOKING_URL: "https://www.booking.com/Share-YPfFO6M",
  ...
  wireLink("bookingCta", bookingUrl, true);
  wireLink("bookingLink", bookingUrl, true);
  wireLink("bookingReviewLink", bookingUrl, true);
